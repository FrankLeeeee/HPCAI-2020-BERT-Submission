...
recompute_grad and original estimator
code
...
def attention_layer(from_tensor,
  ...
  """
    ...
    def calc_attention(from_t, to_t, attn_mask):
        ...
        from_t_2d = reshape_to_matrix(from_t)
        to_t_2d = reshape_to_matrix(to_t)
        ...
        if attn_mask is not None:
            ...
            adder = (1.0 -
                     tf.cast(attn_mask, attention_scores.dtype)) * -10000.0
    ...
    calc_attention = tf.contrib.layers.recompute_grad(calc_attention)
    context_layer = calc_attention(from_tensor, to_tensor, attention_mask)
    return context_layer
